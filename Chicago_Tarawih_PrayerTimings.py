...
# Updated Mosque Data
mosque_data = {
    "Mosque #": list(range(1, 22)),  # Mosque numbers starting from 1
    "Mosque Name": [
        ...
        "Masjid Noor", "UIC MSA", "ICC", "DIC", "Islamic Oasis Center & Mosque"
    ],
    "Isha Iqamah/ Tarawih Starts Immediately After": [
        ...
        "7:30 PM", "7:30 PM", "8:00 PM", "8:15 PM", "7:30 PM", "8:00 PM", "7:00 PM"
    ],
    ...
    "Address": [
        ...
        "750 S Halsted St, Chicago, IL (SCE 713)", "5933 N Lincoln Ave, Chicago, IL",
        "231 S State St #4, Chicago, IL (5th Floor)", "4201 N Monticello Ave, Chicago, IL"
    ]
}
...
st.markdown("<p class='author-text'>Author: B.M</p>", unsafe_allow_html=True)
